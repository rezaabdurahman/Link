  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        className="ios-text-field w-full pl-11 pr-4 py-3 bg-surface-hover/60 border-none rounded-ios text-white placeholder:text-transparent focus:ring-2 focus:ring-aqua/50 relative z-0"
      />
