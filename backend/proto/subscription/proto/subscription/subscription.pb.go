...
const file_proto_subscription_subscription_proto_rawDesc = "" +
	"\n" +
	"%proto/subscription/subscription.proto\x12\fsubscription\x1a\x1fgoogle/protobuf/timestamp.proto\"/\n" +
...
var file_proto_subscription_subscription_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
