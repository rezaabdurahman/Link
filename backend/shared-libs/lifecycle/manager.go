...
// CreateHealthHandler creates a standard http.HandlerFunc for detailed health checks.
func (sm *ServiceManager) CreateHealthHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		case StateDegraded, StateStarting, StateShuttingDown, StateStopped:
...
// CreateReadinessHandler creates a standard http.HandlerFunc for readiness probes.
func (sm *ServiceManager) CreateReadinessHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var status int
...
// CreateLivenessHandler creates a standard http.HandlerFunc for liveness probes.
func (sm *ServiceManager) CreateLivenessHandler() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var status int
		var data map[string]interface{}
		state := sm.GetState()
