...
const handleResponse = async <T>(response: Response): Promise<T> => {
  ...
  try {
    ...
    console.log('🔍 UnifiedSearchClient: Parsed response data:', data);
    return data;
  } catch (error) {
...
export const unifiedSearch = async (
  ...
  console.log('🔍 UnifiedSearchClient: API_CONFIG.BASE_URL:', API_CONFIG.BASE_URL);
  ...
  console.log('🔍 UnifiedSearchClient: Response headers:', Object.fromEntries(response.headers.entries()));
